/**
 * WorkspaceHistory — the full-height right-side generation history
...
const dubInputType = (item) => {
  try {
    ...
    // Audio-only dubbing was added after dub history existed, so malformed or
    // older rows retain the original video default.
    return 'video';
  }
};
