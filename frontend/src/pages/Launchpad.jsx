...
export default function Launchpad({
  ...
  return (
    <div className="launchpad" ref={rootRef}>
      {/* Hero */}
      <div className="relative z-[1] mx-auto w-full max-w-[1180px] px-[44px] pb-[20px] pt-[34px] max-[900px]:px-[20px] max-[900px]:pb-[16px] max-[900px]:pt-[24px]">
      ...
      {/* Feature cards — one full-width, responsive grid at every shell width.
          ...
          columns pack. */}
      <div className="relative z-[1] mx-auto w-full max-w-[1180px] px-[44px] py-[4px] max-[900px]:px-[20px] max-[640px]:px-[12px]">
