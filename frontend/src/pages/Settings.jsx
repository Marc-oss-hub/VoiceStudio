...
export default function Settings() {
  ...
  return (
    ...
    <div className="flex h-full min-h-0 w-full box-border flex-1 flex-col overflow-y-auto bg-[var(--chrome-bg)] p-[var(--space-5)_var(--space-7)_var(--space-7)] font-sans min-[760px]:grid min-[760px]:overflow-hidden min-[760px]:[grid-template-columns:var(--settings-rail)_minmax(0,1fr)] min-[760px]:[grid-template-rows:minmax(0,1fr)] min-[760px]:gap-[var(--space-5)]">
      <aside className="mb-[var(--space-4)] min-[760px]:flex min-[760px]:h-full min-[760px]:min-h-0 min-[760px]:flex-col min-[760px]:overflow-hidden min-[760px]:mb-0">
      ...
      <div className="min-w-0 w-full max-w-[1100px] mx-auto flex-auto self-start [container-type:inline-size] [container-name:settings] min-[760px]:flex min-[760px]:h-full min-[760px]:min-h-0 min-[760px]:flex-col min-[760px]:overflow-hidden min-[760px]:pr-[var(--space-2)]">
        ...
        <div className="[&>*:first-child]:mt-0 min-[760px]:min-h-0 min-[760px]:flex-1 min-[760px]:overflow-y-auto min-[760px]:overscroll-contain">
