...
| **Multi-Lang** | Flag-based batch picker preserving the primary target plus every extra language, with persistent variants, review progress, resumable translation, and one retained export track per language |
