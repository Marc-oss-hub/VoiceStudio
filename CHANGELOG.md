...
- The Dub editor keeps project metadata, pipeline position, and Save/Reset in one compact command bar; generation, verification, and export now live together below the workspace.
